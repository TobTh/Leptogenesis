...
\todo{Nochmal anschauen, sigma 2, linkshändiger projektor}
\begin{figure}[H]
	\begin{equation*}
	\feynmandiagram [small,baseline=(d.base), horizontal=d to b] {
	...
	\feynmandiagram [small,baseline=(d.base), horizontal=d to b] {
		...
		d  --[thick,edge label=N] b  };  \quad \sim iP_R
	\end{equation*}
	with
	...
	\end{equation*}
	the chirality operators, with $\gamma^5=i\gamma^0\gamma^1\gamma^2\gamma^3$, where $\gamma^i$ denotes the gamma matrices.This chirality operator here enters the matrix element because the heavy neutrino N, per defnition, is right-handed. The whole matrix element will be given in the following section.
\end{figure}
