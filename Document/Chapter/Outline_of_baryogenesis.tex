...
\label{eq:numerX}
\end{equation}
Analogously one gets the number density for the corresponding antiparticle $\bar{\text{X}}$
\begin{equation}
...
\subsubsection{Departure from thermal equilibrium and elecroweak phase transition}
